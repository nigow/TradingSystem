...
public class CSVTradeGateway implements TradeGateway {
    ...
    public Trade findTradeById(int id) {
        if (trades.containsKey(id)) {
            ...
            // TODO look at the new constructor of Trade and account for tradeCompletions  --maryam
            //  the last editor param is gone and the new constructor takes in more variables
