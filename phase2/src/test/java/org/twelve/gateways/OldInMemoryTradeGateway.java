...
public class OldInMemoryTradeGateway implements TradeGateway{
    public final Map<Integer, OldTrade> tradeMap;
    public final Map<Integer, TimePlace> timePlaceMap;

    public OldInMemoryTradeGateway(Map<Integer, OldTrade> trades, Map<Integer, TimePlace> timePlace){
