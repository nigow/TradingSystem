...
public class OldTrade {
    ...
    /**
     * Creates a OldTrade object based on input. The status is set to unconfirmed.
     *
     ...
     */
    public OldTrade(int id, int timePlaceID, boolean isPermanent, int traderOneID, int traderTwoID,
